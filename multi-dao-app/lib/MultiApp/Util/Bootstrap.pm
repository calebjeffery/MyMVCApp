package MultiApp::Util::Bootstrap;
...
sub init_logging {
    ...
    if ($root) {
        $log_file = abs_path( File::Spec->catfile( $root, 'logs', 'multiapp.log' ) );
    ...
    Log::Log4perl->init(
        {
            ...
            'log4perl.appender.File.filename'                   => ( $log_file || 'logs/multiapp.log' ),
            ...
            'log4perl.logger.MultiApp'                          => 'DEBUG',
        }
    );
